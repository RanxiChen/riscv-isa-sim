...
void disassembler_t::add_instructions(const isa_parser_t* isa, bool strict)
{
  ...
  if (isa->has_any_matrix() || !strict) {
    ...
    DISASM_INSN("mfmacc.s.h", mfmacc_s_h, 0, {&m_md, &m_ms2, &m_ms1});
    DISASM_INSN("mfmacc.s.bf16", mfmacc_s_bf16, 0, {&m_md, &m_ms2, &m_ms1});
    DISASM_INSN("mfmacc.d.s", mfmacc_d_s, 0, {&m_md, &m_ms2, &m_ms1});
    DISASM_INSN("mfmacc.h.e4", mfmacc_h_e4, 0, {&m_md, &m_ms2, &m_ms1});
    DISASM_INSN("mfmacc.h.e5", mfmacc_h_e5, 0, {&m_md, &m_ms2, &m_ms1});
    DISASM_INSN("mfmacc.bf16.e4", mfmacc_bf16_e4, 0, {&m_md, &m_ms2, &m_ms1});
    ...
    DISASM_INSN("madd.w.mm", madd_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("madd.w.mv.i", madd_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("msub.w.mm", msub_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("msub.w.mv.i", msub_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mmul.w.mm", mmul_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mmul.w.mv.i", mmul_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mmulh.w.mm", mmulh_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mmulh.w.mv.i", mmulh_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mmax.w.mm", mmax_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mmax.w.mv.i", mmax_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mumax.w.mm", mumax_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mumax.w.mv.i", mumax_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mmin.w.mm", mmin_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mmin.w.mv.i", mmin_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mumin.w.mm", mumin_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mumin.w.mv.i", mumin_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("msrl.w.mm", msrl_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("msrl.w.mv.i", msrl_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("msll.w.mm", msll_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("msll.w.mv.i", msll_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("msra.w.mm", msra_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("msra.w.mv.i", msra_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfadd.h.mm", mfadd_h_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfadd.h.mv.i", mfadd_h_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfadd.s.mm", mfadd_s_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfadd.s.mv.i", mfadd_s_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfadd.d.mm", mfadd_d_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfadd.d.mv.i", mfadd_d_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfsub.h.mm", mfsub_h_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfsub.h.mv.i", mfsub_h_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfsub.s.mm", mfsub_s_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfsub.s.mv.i", mfsub_s_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfsub.d.mm", mfsub_d_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfsub.d.mv.i", mfsub_d_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfmul.h.mm", mfmul_h_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mfmul.h.mv.i", mfmul_h_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mfmul.s.mm", mfmul_s_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    ...
    DISASM_INSN("mfcvtl.h.e4", mfcvtl_h_e4, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.h.e4", mfcvth_h_e4, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.h.e5", mfcvtl_h_e5, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.h.e5", mfcvth_h_e5, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.e4.h", mfcvtl_e4_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.e4.h", mfcvth_e4_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.e5.h", mfcvtl_e5_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.e5.h", mfcvth_e5_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.s.h", mfcvtl_s_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.s.h", mfcvth_s_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.h.s", mfcvtl_h_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.h.s", mfcvth_h_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.s.bf16", mfcvtl_s_bf16, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.s.bf16", mfcvth_s_bf16, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.bf16.s", mfcvtl_bf16_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.bf16.s", mfcvth_bf16_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.d.s", mfcvtl_d_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.d.s", mfcvth_d_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.s.d", mfcvtl_s_d, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.s.d", mfcvth_s_d, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.e4.s", mfcvtl_e4_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.e4.s", mfcvth_e4_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvtl.e5.s", mfcvtl_e5_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfcvth.e5.s", mfcvth_e5_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("msfcvtl.h.b", msfcvtl_h_b, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("msfcvth.h.b", msfcvth_h_b, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mufcvtl.h.b", mufcvtl_h_b, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mufcvth.h.b", mufcvth_h_b, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("msfcvt.s.w", msfcvt_s_w, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mufcvt.s.w", mufcvt_s_w, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfscvtl.b.h", mfscvtl_b_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfscvth.b.h", mfscvth_b_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfucvtl.b.h", mfucvtl_b_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfucvth.b.h", mfucvth_b_h, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfscvt.w.s", mfscvt_w_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mfucvt.w.s", mfucvt_w_s, 0, {&m_acc_reg, &m_whole_ms1});
    DISASM_INSN("mn4clipl.w.mm", mn4clipl_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mn4clipl.w.mv.i", mn4clipl_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mn4cliph.w.mm", mn4cliph_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mn4cliph.w.mv.i", mn4cliph_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mn4cliplu.w.mm", mn4cliplu_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mn4cliplu.w.mv.i", mn4cliplu_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
    DISASM_INSN("mn4cliphu.w.mm", mn4cliphu_w_mm, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1});
    DISASM_INSN("mn4cliphu.w.mv.i", mn4cliphu_w_mv_i, 0, {&m_acc_reg, &m_whole_ms2, &m_whole_ms1_uimm3});
